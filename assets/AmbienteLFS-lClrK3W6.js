import{j as e}from"./index-K1a8hxkV.js";import{P as i}from"./PageContainer-BFvVnrCN.js";import{C as s}from"./CodeBlock-DvB8XoAE.js";import{A as o}from"./AlertBox-C_JmkQL6.js";function c(){return e.jsxs(i,{title:"Variáveis de Ambiente do Usuário lfs",subtitle:"Configure ~/.bash_profile e ~/.bashrc para um shell limpo, previsível e isolado do host.",difficulty:"intermediario",timeToRead:"6 min",children:[e.jsx("h2",{children:"Por que isolar o ambiente?"}),e.jsxs("p",{children:["Variáveis como ",e.jsx("code",{children:"CFLAGS"}),", ",e.jsx("code",{children:"LDFLAGS"}),", ",e.jsx("code",{children:"PATH"})," ","herdadas do host podem contaminar a build da toolchain — resultando em binários que não funcionam fora do host. Vamos zerar tudo."]}),e.jsx("h2",{children:e.jsx("code",{children:"~/.bash_profile"})}),e.jsx(s,{language:"bash",code:`cat > ~/.bash_profile << "EOF"
