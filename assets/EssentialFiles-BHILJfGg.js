import{j as s}from"./index-ZrM6Gh7j.js";import{P as a}from"./PageContainer-jOSfeH0u.js";import{C as e}from"./CodeBlock-cFXLaLiU.js";function l(){return s.jsxs(a,{title:"Arquivos & Symlinks Essenciais",subtitle:"/etc/passwd, /etc/group, mtab, logs vazios — o esqueleto que o sistema precisa.",difficulty:"intermediario",timeToRead:"5 min",children:[s.jsx("h2",{children:"Symlinks tradicionais"}),s.jsx(e,{language:"bash",code:"ln -sv /proc/self/mounts /etc/mtab"}),s.jsx("h2",{children:"/etc/hosts"}),s.jsx(e,{language:"bash",code:`cat > /etc/hosts << EOF
