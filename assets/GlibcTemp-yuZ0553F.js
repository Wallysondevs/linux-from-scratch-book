...
rm -v a.out`}),e.jsxs(i,{type:"warning",title:"Saída diferente?",children:["Se aparecer ",e.jsx("code",{children:"/lib/ld-linux.so"})," apontando para o host, algo está errado. Pare. Releia os passos de Binutils Pass 1 e GCC Pass 1."]}),e.jsx("h2",{children:"Limpando"}),e.jsx(s,{language:"bash",code:`cd $LFS/sources
rm -rf glibc-2.42`})]})}export{d as default};
