...
cd /sources && rm -rf linux-6.16.1`}),e.jsx("h2",{children:"Configurando o linker dinâmico do kernel"}),e.jsx(i,{language:"bash",code:`install -v -m755 -d /etc/modprobe.d
...
EOF`}),e.jsx(o,{type:"success",title:"Kernel pronto!",children:"Próximo passo: instalar o GRUB para que o BIOS/UEFI saiba como carregar esse kernel."})]})}export{l as default};
