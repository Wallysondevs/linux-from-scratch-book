import{j as s}from"./index-ZrM6Gh7j.js";import{P as i}from"./PageContainer-jOSfeH0u.js";import{C as e}from"./CodeBlock-cFXLaLiU.js";function l(){return s.jsxs(i,{title:"Ncurses, Sed, Psmisc, Gettext (final)",subtitle:"Recompilando ncurses para o sistema final, mais sed, ps/kill/pstree e gettext.",difficulty:"intermediario",timeToRead:"5 min",children:[s.jsx("h2",{children:"Ncurses (final)"}),s.jsx(e,{language:"bash",code:`cd /sources
...
cd .. && rm -rf gettext-0.26`})]})}export{l as default};
