import{j as e}from"./index-ZrM6Gh7j.js";import{P as i}from"./PageContainer-jOSfeH0u.js";import{C as s}from"./CodeBlock-cFXLaLiU.js";function o(){return e.jsxs(i,{title:"Rede Avançada (BLFS)",subtitle:"Wi-Fi, OpenSSH, NetworkManager, firewall — o que adicionar para sair do 'cabo + IP estático'.",difficulty:"intermediario",timeToRead:"5 min",children:[e.jsx("h2",{children:"Wi-Fi"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"wpa_supplicant"})," — autenticação WPA2/WPA3."]}),e.jsxs("li",{children:[e.jsx("code",{children:"iw"})," + ",e.jsx("code",{children:"iwd"})," — substituto moderno do wpa_supplicant em algumas distros."]}),e.jsxs("li",{children:["Drivers: kernel-tree (firmware vem em ",e.jsx("code",{children:"/lib/firmware"}),")."]})]}),e.jsx("h2",{children:"OpenSSH"}),e.jsx(s,{language:"bash",code:`tar -xf openssh-9.8p1.tar.gz && cd openssh-9.8p1
