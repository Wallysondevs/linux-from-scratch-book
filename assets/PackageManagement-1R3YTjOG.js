import{j as a}from"./index-CGptwfLb.js";import{P as r}from"./PageContainer-DhWxB77g.js";import{C as e}from"./CodeBlock-DiEVa7fR.js";import{A as s}from"./AlertBox-DblzR--W.js";function l(){return a.jsxs(r,{title:"Gerenciamento de Pacotes",subtitle:"LFS não vem com apt nem dnf. Veja as estratégias que a comunidade usa para gerenciar atualizações.",difficulty:"avancado",timeToRead:"6 min",children:[a.jsx(s,{type:"info",title:"Pré-requisitos",children:'Ter sistema Linux funcional como host e ler "O que é LFS".'}),a.jsx("h2",{children:"Glossário rápido"}),a.jsxs("ul",{children:[a.jsxs("li",{children:[a.jsx("strong",{children:"Package manager"})," "," — "," ","LFS não tem."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"Userland tracking"})," "," — "," ","LFS apêndice."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"Stow"})," "," — "," ","simples."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"BLFS"})," "," — "," ","sugestões."]})]}),a.jsx("h2",{children:"Por que LFS não tem package manager?"}),a.jsx("p",{children:"O LFS é educacional — instalar um package manager mascararia o que cada pacote faz. Mas quando você terminar e quiser atualizar pacotes, vai precisar de algum método."}),a.jsx("h2",{children:"Estratégia 1 — Subir tudo pra DESTDIR"}),a.jsx(e,{language:"bash",code:`# Em vez de "make install":
