import{j as s}from"./index-Dq2pq_L0.js";import{P as t}from"./PageContainer-CRFAuOt2.js";import{C as e}from"./CodeBlock-DfTRrP6d.js";import{A as i}from"./AlertBox-DFdNRTyW.js";function d(){return s.jsxs(t,{title:"Systemd (ou SysV-Init)",subtitle:"Sistema de init. Escolha um dos dois — não use os dois ao mesmo tempo.",difficulty:"avancado",timeToRead:"8 min",children:[s.jsxs(i,{type:"warning",title:"Decisão importante",children:["Você está construindo a edição ",s.jsx("strong",{children:"LFS-systemd"})," ou"," ",s.jsx("strong",{children:"LFS-SysV"}),"? A escolha foi feita lá no início (capítulo"," ",s.jsx("a",{href:"#/versao-lfs",children:"Versão LFS"}),"). Cada caminho usa um sistema de init diferente."]}),s.jsx("h2",{children:"Caminho A — Systemd (recomendado para uso moderno)"}),s.jsx(e,{language:"bash",code:`cd /sources
