...
EOF
cd .. && rm -rf vim-9.1.1629`}),e.jsx(r,{type:"info",title:"Prefere Nano?",children:"Vim é o padrão do livro, mas você pode instalar nano depois (BLFS) se preferir. Para iniciantes, nano é mais amigável; vim recompensa a curva de aprendizado."})]})}export{d as default};
