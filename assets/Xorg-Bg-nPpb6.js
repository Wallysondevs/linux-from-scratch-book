import{j as e}from"./index-CGptwfLb.js";import{P as r}from"./PageContainer-DhWxB77g.js";import{C as i}from"./CodeBlock-DiEVa7fR.js";import{A as s}from"./AlertBox-DblzR--W.js";function t(){return e.jsxs(r,{title:"Configurando Xorg",subtitle:"Visão geral de como instalar o servidor gráfico X.org no LFS via BLFS.",difficulty:"avancado",timeToRead:"6 min",children:[e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Xorg"})," "," — "," ","X11 server."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"BLFS"})," "," — "," ","aborda."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Drivers"})," "," — "," ","Mesa."]})]}),e.jsx("h2",{children:"Pré-requisitos enormes"}),e.jsx("p",{children:"Xorg precisa de muitas bibliotecas: libpng, libjpeg, freetype, fontconfig, pixman, mesa, libdrm, libxcb, dezenas de protocolos XML/XCB, e outros. Cada um é um capítulo no BLFS."}),e.jsxs("h2",{children:["Definindo a variável ",e.jsx("code",{children:"$XORG_PREFIX"})]}),e.jsx(i,{language:"bash",code:`export XORG_PREFIX=/usr
