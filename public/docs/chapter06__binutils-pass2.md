...
O sistema de build do Binutils depende de uma cópia do libtool fornecida para ligar contra bibliotecas estáticas internas, mas as cópias de libiberty e zlib fornecidas no pacote não usam libtool. Essa inconsistência pode fazer com que binários produzidos sejam erroneamente ligados a bibliotecas da distro host. Contorne este problema:
...
Compila libbfd como uma biblioteca compartilhada.
