...
A biblioteca libncurses.so é necessária por alguns pacotes que construiremos em breve. Criamos este symlink para usar libncursesw.so como substituto.
...
Detalhes sobre este pacote estão localizados em [Seção 8.30.2, “Conteúdo do Ncurses.”](#/page/chapter08__ncurses)
