...
Em outros sistemas host, /dev/shm é um ponto de montagem para um tmpfs. Nesse caso, a montagem de /dev acima criará apenas /dev/shm como um diretório no ambiente chroot. Nesta situação, devemos montar explicitamente um tmpfs:
