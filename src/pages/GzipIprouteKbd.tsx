...
cd .. && rm -rf gzip-1.13`}
      ...
      <CodeBlock
        language="bash"
        code={`tar -xf iproute2-6.10.0.tar.xz && cd iproute2-6.10.0
...
cd .. && rm -rf iproute2-6.10.0`}
      />

      <h2>Kbd</h2>
      <CodeBlock
        language="bash"
        code={`tar -xf kbd-2.6.4.tar.xz && cd kbd-2.6.4
...
cd .. && rm -rf kbd-2.6.4`}
      ...
      <CodeBlock
        language="bash"
        code={`tar -xf libpipeline-1.5.7.tar.gz && cd libpipeline-1.5.7
./configure --prefix=/usr
make && make install
